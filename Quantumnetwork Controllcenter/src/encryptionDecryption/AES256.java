...
/**
 * Class for AES-256 encryption and decryption of Strings using the CBC Mode
 * 
...
public class AES256 {
	...
	//generating hardcoded IV
	static byte[] byteIv = {42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42};
	static IvParameterSpec iv = new IvParameterSpec(byteIv);
	...
	private static SecretKey stringToSecretKey(String str) {
		...
		//wrapping keyinformation in SecretKey class for AES 
	 ...
	 * @param strKey either a key generated by KeyGenerator for AES and then encrypted to String with Base64 or a bitString with 256 bits
	 * @return A String containing the encrypted plain text
	 */
	public static String encrypt(String strPlaintext, String strKey) {
		...
		try {
			...
			System.out.println("An ERROR occured during encryption:" + e.toString());
		}
		return null;
	}
	...
	public static String decrypt(String strCiphertext, String strKey) {
		...
		try {
			...
			//printing exception 
			//TODO later printing exception to UI
			System.out.println("An ERROR occured during decryption:" + e.toString());
		}
		return null;
	}
