...
public class MessageSystem {
	...
	/*
	 * TODO: one method each for sending encrypted and non-encrypted text messages, then make the two methods above private
	 * same for files (this prevents erronous calls / desync errors based on programmers being inexperienced or confused)
	 */
