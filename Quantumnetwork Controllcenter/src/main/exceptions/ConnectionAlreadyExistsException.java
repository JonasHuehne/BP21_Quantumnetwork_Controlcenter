 ...
 * with a name that is the same as another connection already managed by that
 * {@linkplain ConnectionManager}.
 * 
 * @author Sasha Petri
 */
public class ConnectionAlreadyExistsException extends Exception {
	 ...
	 * 
	 * @param name name of the connection that already exists
	 */
